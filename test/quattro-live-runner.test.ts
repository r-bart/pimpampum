...
function responseFor(label: string) {
  ...
  const responses: Record<string, ReturnType<typeof commandResult>> = {
    ...
    'ready-active-project': commandResult('{"id":"active-id","revision":2}\n'),
    'seed-task': commandResult('{"id":"task-id"}\n'),
    'seed-claim': commandResult('{"revision":2}\n'),
    'seed-completed-project': commandResult('{"id":"complete-id","revision":1}\n'),
    'ready-completed-project': commandResult('{"id":"complete-id","revision":2}\n'),
    'start-completed-project': commandResult('{"revision":3}\n'),
    'complete-project': commandResult('{"state":"done"}\n'),
