...
function fixture() {
  ...
  const transcript = [
    ...
    command('install', process.execPath, [cli, 'install'], '{"data":{"installed":true}}\n'),
    command('status-online', process.execPath, [cli, 'status'], '{"data":{"running":true}}\n'),
    ...
    command(
      ...
      '{"data":{"id":"project-id","revision":1}}\n',
    ),
    command(
      'seed-active-spec',
      process.execPath,
      [cli, 'spec:create', 'project-id', 'widget-v1', 'Widget V1', specBody],
      '{"data":{"id":"active-spec-id","revision":1}}\n',
    ),
    command(
      'ready-active-spec',
      process.execPath,
      [cli, 'spec:ready', 'active-spec-id', '1'],
      '{"data":{"id":"active-spec-id","revision":2}}\n',
    ),
    command(
      'open-active-project',
      process.execPath,
    ...
    command('status-recovered', process.execPath, [cli, 'status'], '{"data":{"running":true}}\n'),
    command('uninstall', process.execPath, [cli, 'uninstall'], '{"data":{"uninstalled":true}}\n'),
...
function fakeRunnerDependencies(
  ...
  const commandResults = new Map<string, { exitCode: number; stdout: string; stderr: string }>([
    ...
    ['install', { exitCode: 0, stdout: '{"data":{"installed":true}}\n', stderr: '' }],
    ['status-online', { exitCode: 0, stdout: '{"data":{"running":true}}\n', stderr: '' }],
    ['seed-workspace', { exitCode: 0, stdout: '{"data":{"id":"live"}}\n', stderr: '' }],
    [
      'seed-project',
      { exitCode: 0, stdout: '{"data":{"id":"project-id","revision":1}}\n', stderr: '' },
    ],
    [
      'seed-active-spec',
      { exitCode: 0, stdout: '{"data":{"id":"active-spec-id","revision":1}}\n', stderr: '' },
    ],
    [
      'ready-active-spec',
      { exitCode: 0, stdout: '{"data":{"id":"active-spec-id","revision":2}}\n', stderr: '' },
    ],
    [
      'open-active-project',
      { exitCode: 0, stdout: '{"data":{"id":"project-id","revision":2}}\n', stderr: '' },
    ],
    ['seed-task', { exitCode: 0, stdout: '{"data":{"id":"task-id"}}\n', stderr: '' }],
    ['seed-claim', { exitCode: 0, stdout: '{"data":{"task":{"revision":1}}}\n', stderr: '' }],
    [
      'seed-completed-project',
      { exitCode: 0, stdout: '{"data":{"id":"completed-id","revision":1}}\n', stderr: '' },
    ],
    [
      'seed-completed-spec',
      { exitCode: 0, stdout: '{"data":{"id":"completed-spec-id","revision":1}}\n', stderr: '' },
    ],
    [
      'ready-completed-spec',
      { exitCode: 0, stdout: '{"data":{"id":"completed-spec-id","revision":2}}\n', stderr: '' },
    ],
    [
      'open-completed-project',
      { exitCode: 0, stdout: '{"data":{"id":"completed-id","revision":2}}\n', stderr: '' },
    ],
    [
      'start-completed-spec',
      { exitCode: 0, stdout: '{"data":{"spec":{"revision":2}}}\n', stderr: '' },
    ],
    [
      'complete-spec',
      {
        exitCode: 0,
        stdout: '{"data":{"id":"completed-spec-id","state":"done","revision":3}}\n',
        stderr: '',
      },
    ],
    [
      ...
      {
        exitCode: 0,
        stdout: '{"data":{"id":"completed-id","state":"done","revision":3}}\n',
        stderr: '',
      },
    ],
    [
    ...
    ['status-recovered', { exitCode: 0, stdout: '{"data":{"running":true}}\n', stderr: '' }],
    ['uninstall', { exitCode: 0, stdout: '{"data":{"uninstalled":true}}\n', stderr: '' }],
  ]);
  const execute = vi.fn(
