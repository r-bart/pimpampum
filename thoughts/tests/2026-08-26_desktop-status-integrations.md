...
The three generated TypeScript acceptance files and four shared fixtures are immutable. Native Swift and QML tests added during implementation supplement them but may not weaken their assertions.
...
- Spec items with immediate generated executable coverage: 28.
...
| `test/desktop-status.lifecycle.acceptance.test.ts` | `50040208e18e5e99d0247b40a20aedbd42d9cf62fe2fd6f808ef74fcbf80735a` |
